...
import DataArchitecture.SkiResort;
...
public class DatabaseFill {
    ...
    public static void main(String[] args) throws UnirestException, FileNotFoundException {
        ...
        for (int id : resortsIDs) {
            ...
            // get weather data
            jsonResponse = Unirest.get("http://api.openweathermap.org/data/2.5/weather?lat="
                    + latitude + "&lon=" + longitude + "&APPID=ae4954f6aa99cd585f31703b2247b4e6").asJson();
            ...
            Unirest.put("https://ski-compass.firebaseio.com/skiresorts/" + id + ".json").body(skiResortData).asJson();
...
// save one json to file for testing
     ...
     * braket...
     *
     * @param json1 JSONObject1 String
     * @param json2 JSONObject2 String
     * @return
     */
    public static String mergeJSON(String json1, String json2) {
        return json1.trim().substring(0, json1.length() - 1)
                + ", " + json2.trim().substring(1);
    }

    /**
     * Adds string "weather" as nested object to "json"
     *
     * @param json1 Json-String to add weather-object to
     * @param weather Json-String containing the weather
     * @return
     */
